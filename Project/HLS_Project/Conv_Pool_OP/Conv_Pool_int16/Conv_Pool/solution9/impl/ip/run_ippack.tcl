...
set IPName      "My_Conv"
set Version     "10.120"
set DisplayName "My_conv"
set Revision    "2113550374"
...
set xo_kernel_name "My_Conv"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/Vivado_program/pynq_lenet5/hls_t1/Conv_short/Conv_Tile129/solution9"
set debug_dir "D:/Vivado_program/pynq_lenet5/hls_t1/Conv_short/Conv_Tile129/solution9/.debug"
set xo_hls_files_dir ""
set hdl_module_list {My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 CHin W 0x0 "Data signal of CHin" {{0 32 CHin W 0 "Bit 31 to 0 of CHin"}}} {0x18 Hin W 0x0 "Data signal of Hin" {{0 32 Hin W 0 "Bit 31 to 0 of Hin"}}} {0x20 Win W 0x0 "Data signal of Win" {{0 32 Win W 0 "Bit 31 to 0 of Win"}}} {0x28 CHout W 0x0 "Data signal of CHout" {{0 32 CHout W 0 "Bit 31 to 0 of CHout"}}} {0x30 Kx W 0x0 "Data signal of Kx" {{0 32 Kx W 0 "Bit 31 to 0 of Kx"}}} {0x38 Ky W 0x0 "Data signal of Ky" {{0 32 Ky W 0 "Bit 31 to 0 of Ky"}}} {0x40 Sx W 0x0 "Data signal of Sx" {{0 32 Sx W 0 "Bit 31 to 0 of Sx"}}} {0x48 Sy W 0x0 "Data signal of Sy" {{0 32 Sy W 0 "Bit 31 to 0 of Sy"}}} {0x50 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 of mode"}}} {0x58 relu_en W 0x0 "Data signal of relu_en" {{0 32 relu_en W 0 "Bit 31 to 0 of relu_en"}}} {0x60 layer W 0x0 "Data signal of layer" {{0 32 layer W 0 "Bit 31 to 0 of layer"}}} {0x68 feature_in1_1 W 0x0 "Data signal of feature_in1" {{0 32 feature_in1 W 0 "Bit 31 to 0 of feature_in1"}}} {0x6c feature_in1_2 W 0x0 "Data signal of feature_in1" {{0 32 feature_in1 W 0 "Bit 63 to 32 of feature_in1"}}} {0x74 feature_in2_1 W 0x0 "Data signal of feature_in2" {{0 32 feature_in2 W 0 "Bit 31 to 0 of feature_in2"}}} {0x78 feature_in2_2 W 0x0 "Data signal of feature_in2" {{0 32 feature_in2 W 0 "Bit 63 to 32 of feature_in2"}}} {0x80 feature_in3_1 W 0x0 "Data signal of feature_in3" {{0 32 feature_in3 W 0 "Bit 31 to 0 of feature_in3"}}} {0x84 feature_in3_2 W 0x0 "Data signal of feature_in3" {{0 32 feature_in3 W 0 "Bit 63 to 32 of feature_in3"}}} {0x8c feature_in4_1 W 0x0 "Data signal of feature_in4" {{0 32 feature_in4 W 0 "Bit 31 to 0 of feature_in4"}}} {0x90 feature_in4_2 W 0x0 "Data signal of feature_in4" {{0 32 feature_in4 W 0 "Bit 63 to 32 of feature_in4"}}} {0x98 Weight1_1 W 0x0 "Data signal of Weight1" {{0 32 Weight1 W 0 "Bit 31 to 0 of Weight1"}}} {0x9c Weight1_2 W 0x0 "Data signal of Weight1" {{0 32 Weight1 W 0 "Bit 63 to 32 of Weight1"}}} {0xa4 Weight2_1 W 0x0 "Data signal of Weight2" {{0 32 Weight2 W 0 "Bit 31 to 0 of Weight2"}}} {0xa8 Weight2_2 W 0x0 "Data signal of Weight2" {{0 32 Weight2 W 0 "Bit 63 to 32 of Weight2"}}} {0xb0 Weight3_1 W 0x0 "Data signal of Weight3" {{0 32 Weight3 W 0 "Bit 31 to 0 of Weight3"}}} {0xb4 Weight3_2 W 0x0 "Data signal of Weight3" {{0 32 Weight3 W 0 "Bit 63 to 32 of Weight3"}}} {0xbc Weight4_1 W 0x0 "Data signal of Weight4" {{0 32 Weight4 W 0 "Bit 31 to 0 of Weight4"}}} {0xc0 Weight4_2 W 0x0 "Data signal of Weight4" {{0 32 Weight4 W 0 "Bit 63 to 32 of Weight4"}}} {0xc8 bias_1 W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 31 to 0 of bias"}}} {0xcc bias_2 W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 63 to 32 of bias"}}} {0xd4 feature_out1_1 W 0x0 "Data signal of feature_out1" {{0 32 feature_out1 W 0 "Bit 31 to 0 of feature_out1"}}} {0xd8 feature_out1_2 W 0x0 "Data signal of feature_out1" {{0 32 feature_out1 W 0 "Bit 63 to 32 of feature_out1"}}} {0xe0 feature_out2_1 W 0x0 "Data signal of feature_out2" {{0 32 feature_out2 W 0 "Bit 31 to 0 of feature_out2"}}} {0xe4 feature_out2_2 W 0x0 "Data signal of feature_out2" {{0 32 feature_out2 W 0 "Bit 63 to 32 of feature_out2"}}} {0xec feature_out3_1 W 0x0 "Data signal of feature_out3" {{0 32 feature_out3 W 0 "Bit 31 to 0 of feature_out3"}}} {0xf0 feature_out3_2 W 0x0 "Data signal of feature_out3" {{0 32 feature_out3 W 0 "Bit 63 to 32 of feature_out3"}}} {0xf8 feature_out4_1 W 0x0 "Data signal of feature_out4" {{0 32 feature_out4 W 0 "Bit 31 to 0 of feature_out4"}}} {0xfc feature_out4_2 W 0x0 "Data signal of feature_out4" {{0 32 feature_out4 W 0 "Bit 63 to 32 of feature_out4"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_IN1 m_axi_IN2 m_axi_IN3 m_axi_IN4 m_axi_W1 m_axi_W2 m_axi_W3 m_axi_W4 m_axi_B1 m_axi_OUT1 m_axi_OUT2 m_axi_OUT3 m_axi_OUT4"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_IN1 {
        ...
        data_width "32"
        port_prefix "m_axi_IN1"
        param_prefix "C_M_AXI_IN1"
    ...
    m_axi_IN2 {
        ...
        data_width "32"
        port_prefix "m_axi_IN2"
        param_prefix "C_M_AXI_IN2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_IN3 {
        ...
        data_width "32"
        port_prefix "m_axi_IN3"
        param_prefix "C_M_AXI_IN3"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_IN4 {
        ...
        data_width "32"
        port_prefix "m_axi_IN4"
        param_prefix "C_M_AXI_IN4"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_OUT1 {
        ...
        data_width "32"
        port_prefix "m_axi_OUT1"
        param_prefix "C_M_AXI_OUT1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_OUT2 {
        ...
        data_width "32"
        port_prefix "m_axi_OUT2"
        param_prefix "C_M_AXI_OUT2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_OUT3 {
        ...
        data_width "32"
        port_prefix "m_axi_OUT3"
        param_prefix "C_M_AXI_OUT3"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_OUT4 {
        ...
        data_width "32"
        port_prefix "m_axi_OUT4"
        param_prefix "C_M_AXI_OUT4"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
...
## System Info
set user_parameters_list {clk_period 4.8 machine 64 combinational 0 latency undef II x}
...
source -notrace "E:/Learning_Software/Xilinx/Vitis_HLS/2022.1/common/scripts/ipxhls.tcl"
