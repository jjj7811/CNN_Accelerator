...
#define CONTROL_ADDR_CHIN_DATA         0x010
#define CONTROL_BITS_CHIN_DATA         32
#define CONTROL_ADDR_HIN_DATA          0x018
#define CONTROL_BITS_HIN_DATA          32
#define CONTROL_ADDR_WIN_DATA          0x020
#define CONTROL_BITS_WIN_DATA          32
#define CONTROL_ADDR_CHOUT_DATA        0x028
#define CONTROL_BITS_CHOUT_DATA        32
#define CONTROL_ADDR_KX_DATA           0x030
#define CONTROL_BITS_KX_DATA           32
#define CONTROL_ADDR_KY_DATA           0x038
#define CONTROL_BITS_KY_DATA           32
#define CONTROL_ADDR_SX_DATA           0x040
#define CONTROL_BITS_SX_DATA           32
#define CONTROL_ADDR_SY_DATA           0x048
#define CONTROL_BITS_SY_DATA           32
#define CONTROL_ADDR_MODE_DATA         0x050
#define CONTROL_BITS_MODE_DATA         32
#define CONTROL_ADDR_RELU_EN_DATA      0x058
#define CONTROL_BITS_RELU_EN_DATA      32
#define CONTROL_ADDR_LAYER_DATA        0x060
#define CONTROL_BITS_LAYER_DATA        32
#define CONTROL_ADDR_FEATURE_IN1_DATA  0x068
#define CONTROL_BITS_FEATURE_IN1_DATA  64
#define CONTROL_ADDR_FEATURE_IN2_DATA  0x074
#define CONTROL_BITS_FEATURE_IN2_DATA  64
#define CONTROL_ADDR_FEATURE_IN3_DATA  0x080
#define CONTROL_BITS_FEATURE_IN3_DATA  64
#define CONTROL_ADDR_FEATURE_IN4_DATA  0x08c
#define CONTROL_BITS_FEATURE_IN4_DATA  64
#define CONTROL_ADDR_WEIGHT1_DATA      0x098
#define CONTROL_BITS_WEIGHT1_DATA      64
#define CONTROL_ADDR_WEIGHT2_DATA      0x0a4
#define CONTROL_BITS_WEIGHT2_DATA      64
#define CONTROL_ADDR_WEIGHT3_DATA      0x0b0
#define CONTROL_BITS_WEIGHT3_DATA      64
#define CONTROL_ADDR_WEIGHT4_DATA      0x0bc
#define CONTROL_BITS_WEIGHT4_DATA      64
#define CONTROL_ADDR_BIAS_DATA         0x0c8
#define CONTROL_BITS_BIAS_DATA         64
#define CONTROL_ADDR_FEATURE_OUT1_DATA 0x0d4
#define CONTROL_BITS_FEATURE_OUT1_DATA 64
#define CONTROL_ADDR_FEATURE_OUT2_DATA 0x0e0
#define CONTROL_BITS_FEATURE_OUT2_DATA 64
#define CONTROL_ADDR_FEATURE_OUT3_DATA 0x0ec
#define CONTROL_BITS_FEATURE_OUT3_DATA 64
#define CONTROL_ADDR_FEATURE_OUT4_DATA 0x0f8
#define CONTROL_BITS_FEATURE_OUT4_DATA 64
