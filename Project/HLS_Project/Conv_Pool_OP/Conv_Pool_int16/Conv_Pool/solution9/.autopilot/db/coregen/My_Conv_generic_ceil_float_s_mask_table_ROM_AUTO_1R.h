...
// ==============================================================
#ifndef __My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R_H__
#define __My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R_H__
...
struct My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R_ram) {
...
SC_MODULE(My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R) {
...
My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R_ram* meminst;


SC_CTOR(My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R) {
meminst = new My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R_ram("My_Conv_generic_ceil_float_s_mask_table_ROM_AUTO_1R_ram");
