...
set C_modelArgList {
	...
	{ weight_buffer int 64 regular {array 1024 { 3 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "W1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "Weight1","offset": { "type": "dynamic","port_name": "Weight1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "weight_buffer", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ m_axi_W1_RFIFONUM sc_in sc_lv 11 signal 0 } 
	...
	{ m_axi_W2_RFIFONUM sc_in sc_lv 11 signal 2 } 
	...
	{ m_axi_W3_RFIFONUM sc_in sc_lv 11 signal 4 } 
	...
	{ m_axi_W4_RFIFONUM sc_in sc_lv 11 signal 6 } 
	...
	{ weight_buffer_address1 sc_out sc_lv 10 signal 8 } 
	{ weight_buffer_ce1 sc_out sc_logic 1 signal 8 } 
	{ weight_buffer_we1 sc_out sc_logic 1 signal 8 } 
	{ weight_buffer_d1 sc_out sc_lv 64 signal 8 } 
	{ Out_LP_now sc_in sc_lv 27 signal 9 } 
	{ In_LP_now sc_in sc_lv 25 signal 10 } 
	{ CHin sc_in sc_lv 32 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_buffer_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "weight_buffer", "role": "we1" }} , 
 	{ "name": "weight_buffer_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "weight_buffer", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_63_2_1_U6", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_3ns_32s_35_2_1_U7", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1040", "Max" : "1041"}
...
set Spec2ImplPortList { 
	...
	weight_buffer { ap_memory {  { weight_buffer_address1 MemPortADDR2 1 10 }  { weight_buffer_ce1 MemPortCE2 1 1 }  { weight_buffer_we1 MemPortWE2 1 1 }  { weight_buffer_d1 MemPortDIN2 1 64 } } }
