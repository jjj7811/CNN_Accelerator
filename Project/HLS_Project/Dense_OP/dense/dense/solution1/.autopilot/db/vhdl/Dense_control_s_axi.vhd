...
end entity Dense_control_s_axi;
...
architecture behave of Dense_control_s_axi is
    ...
    constant ADDR_CHOUT_DATA_0       : INTEGER := 16#18#;
    constant ADDR_CHOUT_CTRL         : INTEGER := 16#1c#;
    constant ADDR_RELU_EN_DATA_0     : INTEGER := 16#20#;
    constant ADDR_RELU_EN_CTRL       : INTEGER := 16#24#;
    constant ADDR_FEATURE_IN_DATA_0  : INTEGER := 16#28#;
    constant ADDR_FEATURE_IN_DATA_1  : INTEGER := 16#2c#;
    constant ADDR_FEATURE_IN_CTRL    : INTEGER := 16#30#;
    constant ADDR_WEIGHT1_DATA_0     : INTEGER := 16#34#;
    constant ADDR_WEIGHT1_DATA_1     : INTEGER := 16#38#;
    constant ADDR_WEIGHT1_CTRL       : INTEGER := 16#3c#;
    constant ADDR_WEIGHT2_DATA_0     : INTEGER := 16#40#;
    constant ADDR_WEIGHT2_DATA_1     : INTEGER := 16#44#;
    constant ADDR_WEIGHT2_CTRL       : INTEGER := 16#48#;
    constant ADDR_WEIGHT3_DATA_0     : INTEGER := 16#4c#;
    constant ADDR_WEIGHT3_DATA_1     : INTEGER := 16#50#;
    constant ADDR_WEIGHT3_CTRL       : INTEGER := 16#54#;
    constant ADDR_WEIGHT4_DATA_0     : INTEGER := 16#58#;
    constant ADDR_WEIGHT4_DATA_1     : INTEGER := 16#5c#;
    constant ADDR_WEIGHT4_CTRL       : INTEGER := 16#60#;
    constant ADDR_BIAS_DATA_0        : INTEGER := 16#64#;
    constant ADDR_BIAS_DATA_1        : INTEGER := 16#68#;
    constant ADDR_BIAS_CTRL          : INTEGER := 16#6c#;
    constant ADDR_FEATURE_OUT_DATA_0 : INTEGER := 16#70#;
    constant ADDR_FEATURE_OUT_DATA_1 : INTEGER := 16#74#;
    constant ADDR_FEATURE_OUT_CTRL   : INTEGER := 16#78#;
