...
(* CORE_GENERATION_INFO = "bd_49ec,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_49ec,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=43,numReposBlks=33,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_smartconnect_0_3.hwdef" *) 
module bd_49ec
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  s02_entry_pipeline_imp_ADDC4I s02_entry_pipeline
       (.aclk(aclk_3),
        .aresetn(aresetn_4),
  ...
  s02_nodes_imp_GOKZR0 s02_nodes
...
module s02_entry_pipeline_imp_ADDC4I
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_49ec_s02mmu_0 s02_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_49ec_s02sic_0 s02_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_49ec_s02tr_0 s02_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
